...
This project explores Form management in React. In your project you will demonstrate proficiency of controled inputs, semantic HTML, some ES6 tools like the spread operator, computer properties, and synthetic events by creating an application using each of these.
